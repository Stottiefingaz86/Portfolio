...
export const CHRIS_AGENT_STARTER_PROMPTS = [
  ...
  'Tell me about the Offshore product transformation',
...
export const CHRIS_AGENT_GREETING =
  "Hi — I'm Chris Agent. Interview me on anything here: leadership, Offshore, design systems, Jurnii, AI workflows, or iGaming product depth.";
