...
export const SITE = {
  ...
  role: 'Head of UI/UX · Head of Design · Creative Director',
  roleLines: ['Head of UI/UX.', 'Head of Design.', 'Creative Director.'],
...
export const SEO = {
  title: 'Christopher Hunt · Head of UI/UX, Head of Design & Creative Director',
  description:
    'Portfolio of Christopher Hunt, a Head of UI/UX and Creative Director-level design leader across online gambling, casino, sportsbook, poker, design systems and AI-powered customer experience.',
  keywords: [
    'Christopher Hunt',
    'Head of UI UX',
    'Head of Design',
...
export const TIMELINE: TimelineEntry[] = [
  {
    ...
    role: 'Head of UI/UX · Head of Design',
