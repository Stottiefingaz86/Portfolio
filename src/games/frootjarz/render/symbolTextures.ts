...
const SYMBOL_IMAGE_MAP: Partial<Record<CellSymbol, string>> = {
  [FruitSymbol.Watermelon]: publicUrl('frootjarz/symbols/s1.png'),
  [FruitSymbol.Pineapple]: publicUrl('frootjarz/symbols/s2.png'),
  [FruitSymbol.Peach]: publicUrl('frootjarz/symbols/s3.png'),
  [FruitSymbol.Blueberry]: publicUrl('frootjarz/symbols/s4.png'),
  [FruitSymbol.Grape]: publicUrl('frootjarz/symbols/s5.png'),
  [FruitSymbol.Pomegranate]: publicUrl('frootjarz/symbols/s6.png'),
  [JAR_WILD]: publicUrl('frootjarz/symbols/jar.png'),
};
